...
//! book again](https://doc.rust-lang.org/book/title-page.html)**. Finally, if
//! you still can't figure out your issue ask for help on piazza or come to
//! office hours if you truly feel stuck.
//!
...
//! rust-analyzer.
//!
//! Unless noted by the TA or instructor, **no dependencies should be added to
//! `Cargo.toml`**. If you feel you need to add an additional dependency to
//! complete one of the lab assignments, consult with the instructor or TA.
//!
//! ## Ready?
//!
